...
#ifndef X265_ANALYSIS_EXT_H
#define X265_ANALYSIS_EXT_H
...
class AnalysisExt : public Analysis
{
public:
    //enum {
    //    PRED_MERGE,
...
protected:
    ...
    */
    ...
    void encodeIntraSyncSizeResidue(const CUGeom& cuGeom, const CUData& parentCU);
...
struct ThreadLocalDataExt : public ThreadLocalData
{
    ThreadLocalDataExt() { analysis = new AnalysisExt; }
    void destroy() { analysis->destroy(); delete analysis; }
};

}

#endif // ifndef X265_ANALYSIS_EXT_H
