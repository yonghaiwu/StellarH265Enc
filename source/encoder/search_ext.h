...
#ifndef X265_SEARCH_EXT_H
#define X265_SEARCH_EXT_H
...
protected:
   ...
   /* ThreadLocalData* m_tld;
    ...
    void getBlkBits(PartSize cuMode, bool bPSlice, int puIdx, uint32_t lastMode, uint32_t blockBit[3]);
...
#endif // ifndef X265_SEARCH_EXT_H
