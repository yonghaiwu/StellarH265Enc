...
#ifndef X265_PREDICT_EXT_H
#define X265_PREDICT_EXT_H
...
class PredictExt : public Predict
{
public:
    ...
    void fillReferenceSamples(const pixel* adiOrigin, intptr_t picStride, const IntraNeighbors& intraNeighbors, pixel dst[258]);
 /*   template<bool cip>
...
#endif // ifndef X265_PREDICT_EXT_H
